...
<input name="flag" value="doAdd" type="hidden">
			...
			<%
				Provider p2=(Provider)session.getAttribute("provider");
			%>
			<tbody><tr>
					<td class="field">供应商编号：</td>
					<td><input name="proId"  value="<%=id %>" id="textfield" class="text" type="text"> <font color="red">*</font></td>
				</tr>
				<tr>
